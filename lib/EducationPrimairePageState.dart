...
class EducationPrimairePageState extends State<EducationPrimairePage>{
  int index = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: Text('Education Primaire'),
      ),
      body: EducationPrimaireBody(),
    );
  }
...
class EducationPrimaireBody extends StatelessWidget {
