...
var _list=[];
class BibliothequeSyllabusPageState extends State<BibliothequeSyllabusPage>{
  int index = 0;
  var _syllabusUrl=Const.SERVER_URL_SYLLABUS;
  ...
  void init() {
    HttpRequest.getJson(_syllabusUrl)
        .then((response) {
...
class BibliothequeSyllabusBody extends StatelessWidget {
