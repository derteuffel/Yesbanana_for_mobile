    ...
    return Scaffold(
      ...
      body: new Stack(
        ...
        children: <Widget>[
          ...
          Center(
              child: _connecting? CircularProgressIndicator(valueColor : new AlwaysStoppedAnimation<Color>(Colors.white)) : null
          ),
          ...
          Padding(
            ...
            child: new Column(
              ...
              children: <Widget>[
                Center(
                  child : text==null? null : Text(text, style : TextStyle(color: Colors.red)),
                ),
                new Text(
                  "YesBanana",
                  style: new TextStyle(
                      ...
                      children: <Widget>[
                        ...
                        new MaterialButton(
                          ...
                          onPressed: () {
                            ...
                            HttpRequest.fetchJson(_connexionUrl, credentials)
                                .then((response) {
                              setState(() {
                                _connecting = false;
                              });
                              ...
                              if (body["status"] == "true") {
                                ...
                                Useful.printMessage("Login ou mot de passe incorrect.");
